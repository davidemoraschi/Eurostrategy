/* Formatted on 08/11/2011 13:52:51 (QP5 v5.139.911.3011) */
SET DEFINE OFF
...
DECLARE
   ...
   var_str_AmazonSES_api_url        VARCHAR2 (2000)
                                       :=    var_str_AmazonSES_api_Endpoint
                                          || '?'
                                          || var_str_AmazonSES_api_Action
                                          || '&Source=davide%40moraschi.com'
                                          || '&Destination.ToAddresses.member.1=dmoraschi%40gmail.com'
                                          || '&Message.Subject.Data='
                                          || utl_linkedin.urlencode (REPLACE ('Una cosa+preziosa', ' ', '%20'))
                                          || '&Message.Body.Html.Data=<h1>Test</h1>';
