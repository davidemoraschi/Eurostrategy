/* Formatted on 1/5/2012 1:25:14 PM (QP5 v5.163.1008.3004) */
CREATE OR REPLACE FUNCTION EUROSTAT.google_analytics_oauth2_auth
   RETURN VARCHAR2
IS
   ...
   v_user_params                   VARCHAR2 (2048) := 'response_type=code';
   h_name                          VARCHAR2 (255);
