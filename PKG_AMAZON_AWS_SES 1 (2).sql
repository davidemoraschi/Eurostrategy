/* Formatted on 08/11/2011 14:10:42 (QP5 v5.139.911.3011) */
CREATE OR REPLACE PACKAGE BODY EUROSTAT.PKG_AMAZON_AWS_SES
IS
   ...
   IS
      ...
      var_str_AmazonSES_api_url        VARCHAR2 (2000)
                                          :=    var_str_AmazonSES_api_Endpoint
                                             ...
                                             || REPLACE (utl_linkedin.urlencode (p_Html_Body), ' ', '%20');
