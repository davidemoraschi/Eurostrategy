CREATE OR REPLACE package body EUROSTAT.ooxml_util_pkg
as
  ...
  */
  ...
  g_line_break_hack              constant varchar2(10) := '|¤¤';
...
function get_pptx_media_list (p_pptx in blob) return t_str_array
as
  l_file_list   zip_util_pkg.t_file_list;
  l_returnvalue t_str_array := t_str_array();
begin
